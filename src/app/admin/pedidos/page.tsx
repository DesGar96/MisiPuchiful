          ...
          <Table responsive hover>
            ...
            <tbody>
              {pedidos.map((pedido) => (
                <tr key={pedido.id}>
                  <td>#{pedido.id}</td>
                  <td>{pedido.usuario_nombre || `Usuario ${pedido.usuario_id}`}</td>
          ...
          {pedidoSeleccionado && (
            <>
              <div className="mb-4">
                ...
                <p><strong>Nombre:</strong> {pedidoSeleccionado.usuario_nombre || 'No especificado'}</p>
                <p><strong>Email:</strong> {pedidoSeleccionado.email || 'No especificado'}</p>
              ...
              <div className="mb-4">
                ...
                <p>
                  {pedidoSeleccionado.metodo_pago === 'contrareembolso' && '💰 Contra reembolso'}
                ...
                <Table size="sm">
                  ...
                  <tbody>
                    {pedidoSeleccionado.detalles?.map((detalle, index) => (
                      <tr key={index}>
                        <td>{detalle.producto_nombre || `Producto #${detalle.producto_id}`}</td>
                  ...
                  <tfoot>
                    <tr>
                      ...
                      <td><strong>{pedidoSeleccionado.total}€</strong></td>
                    </tr>
                  </tfoot>
                </Table>
              </div>
